    ...
    def __getitem__(self, index):
        ...
        if not image_files==[]:
            for image in image_files:
                ...
                new_affine = new_affine + np.array([[0, 0, 0, -78], [0, 0, 0, -300], [0, 0, 0, -70], [0, 0, 0, 0]])
                x = np.zeros((189, 157, 156))
...
path = '/nfs/masi/bayrakrg/tractem_data/corrected'
output_path = '/nfs/masi/wangx41/changed_header_density'
