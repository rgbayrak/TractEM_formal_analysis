            ...
            for tractfolder in os.listdir(folder):
                ...
                if not region_list == []:
                      ...
                      if short_name[file_name.index(tractfolder)] == 'fx':
                          ...
                          print(program)
                          print(program1)
                          skip_timeout(program,1200)
                          skip_timeout(program1,1200)
                      else:
...
dire=['7759_Aviral','1632_Yufei','1127_Yufei','1134_Yi','7678_Yi','1134_Christa_2','5708_Christa','1834_Christa','7748_Eugene']
...
out_path='/nfs/masi/wangx41/original_tract/BLSA1'
