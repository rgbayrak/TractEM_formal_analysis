...
def create_tract(in_path_den,in_path_ROA,out_path,txtfile,file_name,short_name):
    ...
    with open(txtfile, 'a') as fileobject:
        ...
        for g in list_ROA:
            ...
            list_ROI=glob.glob(os.path.expanduser(os.path.join(in_path_den,'%s_*.nii.gz'%short)))
...
for i in list1:
    in_path_ROA='/nfs/masi/wangx41/sum_average/1578/average_ROA_0.1'
    in_path_den='/nfs/masi/wangx41/sum_average/1578/average_0.0/average_%s'%i
    out_path='/nfs/masi/wangx41/autotract_methord1/binary_0.0/average_ROA0.1_ROI%s'%i
