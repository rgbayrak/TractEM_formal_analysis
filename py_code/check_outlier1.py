        ...
        for second_path in os.listdir(first_path):
            for third_path in os.listdir(os.path.join(first_path, second_path)):
                for forth_path in os.listdir(os.path.join(first_path, second_path,third_path)):
                    self.folder_path = forth_path
                    self.dir.append(os.path.join(first_path, second_path,third_path,self.folder_path))
        #self.dir = self.dir[::2]
        #del self.dir[0]
        #print( self.dir[0])
        ...
        # print(image_path)
            ...
            if folder_name in self.file_name:
                ...
                if ('seed' in list_all) or ('ROA' in list_all) or ('ROI' in list_all) or ('end' in list_all):
                    R0 = '\n' + 'missing 1 in ' + track_path
                    print(2)
                    fileobject.write(R0)

                if 'density' in list_all:
                    R9 = '\n' + 'Extra density or tract file in ' + track_path
                    print(1)
                    fileobject.write(R9 )
...
first_path= '/share4/wangx41/regions'
...
error_txt='/home-local/wangx41/eoror_record.txt'
data=check_name(first_path,file_name,error_txt,short_name,number_seeds,number_roi,number_roa)
for i in range(2121):
    data[i]
