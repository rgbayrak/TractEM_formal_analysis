function [t1,seg,dwi,mask,grad,bvals,bvecs] = a20_get_BLSA_filenames(blsa_dir)
...
zseg = [blsa_dir '/' sess '/*macruise_v3*/SegRefine/SEG_refine.nii.gz'];
system(['gunzip ' zseg]);
seg = zseg(1:end-3);

% % segRefine added by Roza
% zsegRef = [blsa_dir '/' sess '/*macruise_v3*/SegRefine/SEG_refine.nii.gz'];
% system(['gunzip ' zsegRef]);
% segRef = zsegRef(1:end-3);
...
[t1,seg] = a22_coregister_t1(dwi,bvals,t1,seg);
