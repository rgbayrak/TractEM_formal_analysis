...
HCP_subject_path = '/nfs/masi/wangx41/auto_tracked_from_corrected_regions/HCP';
...
save('autohcp_corrected_data.mat', 'hcp_data');
...
save('autohcp_error_data.mat', 'tract_first_error');
%%
orig = load('autohcp_original_data.mat');
sum([orig.hcp_data.error_count])
orig.hcp_data([orig.hcp_data.error_count]>0)

corr = load('autohcp_corrected_data.mat');
