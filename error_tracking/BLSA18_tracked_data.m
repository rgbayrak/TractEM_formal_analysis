...
BLSA_subject_path = '/nfs/masi/bayrakrg/tractem_data/corrected/BLSA18';
BLSA_subject_dirs = dir(BLSA_subject_path);

% The last version of the protocol
ac = {'ac_seed1.nii.gz', 'ac_ROA1.nii.gz', ...
...
save('blsa18_corrected_data.mat', 'blsa_data');
...
save('blsa18_error_data.mat', 'tract_first_error');
