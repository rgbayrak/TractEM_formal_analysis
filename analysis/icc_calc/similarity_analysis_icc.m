...
% % Data directories
exDir              = '/share4/bayrakrg/tractEM/postprocessing/*-tracts/BLSA18/BLSA_11';
...
for l = 1:length(abbList)
    ...
    if length(strfind(densityDir(1).name,'_')) == 1
        ...
        save(['/share4/bayrakrg/tractEM/postprocessing/metric_analysis/icc/auto_icc_mat/BLSA18/BLSA_11/' abbList{l} '_icc.mat'], 'iccMatrix');           
        save(['/share4/bayrakrg/tractEM/postprocessing/metric_analysis/icc/auto_icc_mat/BLSA18/BLSA_11/' abbList{l} '_nameMe'], 'nameMe');
        % plotting
        ...
        saveas(r,['/share4/bayrakrg/tractEM/postprocessing/metric_analysis/icc/auto_icc/BLSA18/BLSA_11/' 'icc_' name '.jpg']); 
        close all;
    ...
    elseif length(strfind(densityDir(1).name,'_')) == 2
        ...
        if length(strfind(densityLDir(1).name,'_L')) == 1
            ...
            save(['/share4/bayrakrg/tractEM/postprocessing/metric_analysis/icc/auto_icc_mat/BLSA18/BLSA_11/' abbList{l} '_L_icc.mat'], 'iccL');           
            save(['/share4/bayrakrg/tractEM/postprocessing/metric_analysis/icc/auto_icc_mat/BLSA18/BLSA_11/' abbList{l} '_L_nameMe'], 'nameMe');
            % plotting
            ...
            name = densityDir(1).name(1:end-15);
            saveas(p,['/share4/bayrakrg/tractEM/postprocessing/metric_analysis/icc/auto_icc/BLSA18/BLSA_11/' 'icc_' name '.jpg']); 
            close all;
        ...
        if length(strfind(densityRDir(1).name,'_R')) == 1
            ...
            save(['/share4/bayrakrg/tractEM/postprocessing/metric_analysis/icc/auto_icc_mat/BLSA18/BLSA_11/' abbList{l} '_R_icc.mat'], 'iccR');
            save(['/share4/bayrakrg/tractEM/postprocessing/metric_analysis/icc/auto_icc_mat/BLSA18/BLSA_11/' abbList{l} '_R_nameMe'], 'nameMe');
            % plotting
            ...
            saveas(q,['/share4/bayrakrg/tractEM/postprocessing/metric_analysis/icc/auto_icc/BLSA18/BLSA_11/' 'icc_' name '.jpg']); 
            close all;
