...
hd90_mat_files = dir(fullfile([matDir, '/*temp_hd90.mat']));
name_mat_files = dir(fullfile([matDir, '/*ROA1_nameMe.mat']));
...
ylabel('ICC');
ylim([0 1])
title('unc L ROA label')


% save('/share4/bayrakrg/tractEM/postprocessing/metric_analysis/label/mhd/icc_ROA1_L_mhd.mat', 'icc_mat_intra_subject')
