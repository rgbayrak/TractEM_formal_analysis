...
for l = 1:length(abbList)
    ...
    if length(strfind(labelDir(1).name,'_')) == 1
        ...
        save(['/share4/bayrakrg/tractEM/postprocessing/metric_analysis/label/mhd/human_mhd_mat/HCP/' abbList{l} '_ROA1_mhd.mat'], 'mhdMatrix');           
    ...
    elseif length(strfind(labelDir(1).name,'_')) == 2
        ...
        if length(strfind(labelLDir(1).name,'_L')) == 1
            ...
            save(['/share4/bayrakrg/tractEM/postprocessing/metric_analysis/label/mhd/human_mhd_mat/HCP/' abbList{l} '_L_ROA1_mhd.mat'], 'mhdL');           
        ...
        if length(strfind(labelRDir(1).name,'_R')) == 1
            ...
            save(['/share4/bayrakrg/tractEM/postprocessing/metric_analysis/label/mhd/human_mhd_mat/HCP/' abbList{l} '_R_ROA1_mhd.mat'], 'mhdR');
