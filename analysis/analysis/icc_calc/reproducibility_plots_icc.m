...
% Load the data
HCP = load('reproducibility/HCP_Apr_icc.mat');
...
simple_tracts = {'Anterior Commissure'; 'Anterior Limb Internal Capsule Left';'Anterior Limb Internal Capsule Right';'Body Corpus Callosum';...
            'Cingulum Cingulate Gyrus Left';'Cingulum Cingulate Gyrus Right'; 'Cerebral Peduncle Left';'Cerebral Peduncle Right';...
            'Genu Corpus Callosum';'Inferior Cerebellar Peduncle Left';'Inferior Cerebellar Peduncle Right'; ...
            'Midbrain';'Middle Cerebellar Peduncle';'Medial Lemniscus Left';'Medial Lemniscus Right'; ...
            'Olfactory Radiation Left';'Olfactory Radiation Right';'Optic Tract';'Posterior Corona Radiata Left';'Posterior Corona Radiata Right';...
            'Posterior Limb Internal Capsule Left';'Posterior Limb Internal Capsule Right';...
            'Splenium Corpus Callosum';'Superior Corona Radiata Left';'Superior Corona Radiata Right'; ...
            'Superior Longitudinal Fasciculus Left';'Superior Longitudinal Fasciculus Right';...
            'Sagittal Stratum Left';'Sagittal Stratum Right';'Uncinate Fasciculus Left';'Uncinate Fasciculus Right'};
...
title('Inter-rater Tract Reliability for HCP', 'FontSize', 18)
...
% HCP = load('reproducibility/HCP_auto_cdice.mat');
% 
% % To exclude some raters
% list_HCP_rater = unique({HCP.all_dice.rater1 HCP.all_dice.rater2});
% mask_HCP_rater = zeros(1,length(list_HCP_rater));
