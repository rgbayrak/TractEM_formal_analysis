...
%%
seg = load_nii('/share4/bayrakrg/tractEM/postprocessing/M-tracts/165436_HCP/SEG/wcT1w_acpc_dc_restore_1.25_seg.nii');
density = load_nii('/share4/bayrakrg/tractEM/postprocessing/M-tracts/165436_HCP/Xuan/gcc_density.nii.gz');
...
p = figure('Visible', 'on');
image(connROI)
title('Connectivity Matrix for Genu Corpus Callosum', 'FontSize', 10); % set title
...
% ytickangle(45)
colormap(parula(1000)); % set the colorscheme
hcb = colorbar;
hcb.Label.String = 'Correlation';
saveas(p,'~/Desktop/gcc_Xuan.jpg'); 
