...
matDir = fullfile(exDir, 'human_mhd_mat/HCP/anterior_corona_radiata');  % directory names are as follows -> subject_rater
...
icc_mat_filesL = dir(fullfile([rep_matDir, '/acr_L_icc.mat']));
icc_mat_filesR = dir(fullfile([rep_matDir, '/acr_R_icc.mat']));
...
% save('/share4/bayrakrg/tractEM/postprocessing/metric_analysis/label/mhd/icc_ROI1_R_mhd.mat', 'icc_mat_intra_subject')
