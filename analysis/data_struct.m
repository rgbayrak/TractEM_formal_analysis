...
exDir              = '/home-local/bayrakrg/Dropbox*VUMC*/tractEM/auto/';
matDir = fullfile(exDir, 'HCP*_mat');  % directory names are as follows -> subject_rater
...
all_dice = struct;
count = 1;
for l = 1:20 %length(dice_mat_files)
...
save('HCP_Aug30_01.mat', 'all_dice')
