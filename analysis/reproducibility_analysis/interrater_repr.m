%% This script is for inter subject and inter rater reproducibility analysis for HCP tractem data
...
exDir              = '/home-local/bayrakrg/Dropbox*VUMC*/tractEM/analysis/HCP/';
matDir = fullfile(exDir, 'HCP_Dice_mat');  % directory names are as follows -> subject_rater
