...
# example: bash seed1_LR_roa1s_roi1.sh /home-local/bayrakrg/BLSA/BLSA_7759/tal_fib.gz /home/local/VANDERBILT/bayrakrg/Desktop/regions/*.nii.gz anterior_corona_radiata acr
...
if [ ! -e "${STRUCTURE}" ] ; then mkdir "${STRUCTURE}" ; fi
