...
subjectID_rater = 'HCP_878877';

% The location of the subject data
D = '/share4/bayrakrg/tractEM/postprocessing/A-tracts/HCP';
D = [D filesep subjectID_rater '/']; 

QA = '/home-local/bayrakrg/Dropbox (VUMC)/complete_HCP_subjects';
QA = [QA filesep subjectID_rater(5:end) '_*/']; 

% The location of the subject FA image. This will be the background image for the density maps
background = [D subjectID_rater(5:end) '_gqi_fib_qa.nii.gz'];
