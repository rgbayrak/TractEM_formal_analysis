            ...
            for j = i:d
                ...
                if diceMatrix(i,j) <= 1
                    if i ~= j && convertCharsToStrings(dirParti(1:4)) == convertCharsToStrings(dirPartj(1:4))
                        ...
                        saveas(figure(1),['/home-local/bayrakrg/Dropbox (VUMC)/HCP/overlay/' dirParti '_vs_' dirPartj '_' name '_overlay.jpg']); 
                        close all;
                ...
                for j = i:dl
                    ...
                    if diceL(i,j) <= 1
                        if i ~= j && convertCharsToStrings(dirParti(1:4)) == convertCharsToStrings(dirPartj(1:4))
                            ...
                            image(L/max(L(:)))
                            ylabel('\bf Axial');
                            name = densityLDir(1).name(1:end-15);
                            title([strrep(dirParti, '_', ' ') ' vs ' strrep(dirPartj, '_', ' ') ' ' name])
                            subplot(2,2,2);
                            ...
                            saveas(figure(2),['/home-local/bayrakrg/Dropbox (VUMC)/HCP/overlay/' dirParti '_vs_' dirPartj '_' name '_overlay.jpg']); 
                            close all;
                ...
                for j = i:dr
                    ...
                    if diceR(i,j) <= 1
                        if i ~= j && convertCharsToStrings(dirParti(1:4)) == convertCharsToStrings(dirPartj(1:4))
                            ...
                            image(R/max(R(:)))
                            ylabel('\bf Axial')
                            name = densityRDir(1).name(1:end-15);
                            title([strrep(dirParti, '_', ' ') ' vs ' strrep(dirPartj, '_', ' ') ' ' name])                            
                            subplot(2,2,2);
                            ...
                            saveas(figure(3),['/home-local/bayrakrg/Dropbox (VUMC)/HCP/overlay/' dirParti '_vs_' dirPartj '_' name '_overlay.jpg']); 
                            close all;
